    ...
    return(
        <div className="keypad">
            <button className="drum-pad" id="heater-1">Q
                ...
                <audio className="clip" id="C" src="https://s3.amazonaws.com/freecodecamp/drums/Heater-1.mp3"/>
                </button>
        </div>
    )
}
